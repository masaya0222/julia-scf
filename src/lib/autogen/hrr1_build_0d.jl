...
function hrr1_build_0d!(AB::Vector{Float64},vp::Vector{Float64}, vp_ind::Int, I0::Vector{Float64}, I0_ind::Int, I1::Vector{Float64}, I1_ind::Int, cd_num::Int)
	AB0 = AB[1]
	AB1 = AB[2]
	AB2 = AB[3]
...
# Total number of FLOPs = 12 * cd_num 
