...
# Computes quartets necessary to compute (pp|dd) integrals

function vrr_order_ppdd!(Libint::Libint_t, Data::prim_data)
	...
	build_00g0!(Data, Libint.int_stack, vrr_stack+171, Libint.int_stack, vrr_stack+75, Libint.int_stack, vrr_stack+101, Libint.int_stack, vrr_stack+15, Libint.int_stack, vrr_stack+33, [0.0], -1)
	build_00g0!(Data, Libint.int_stack, vrr_stack+186, Libint.int_stack, vrr_stack+85, Libint.int_stack, vrr_stack+75, Libint.int_stack, vrr_stack+24, Libint.int_stack, vrr_stack+15, [0.0], -1)
	build_00p0!(Data, Libint.int_stack, vrr_stack+0, Data.F, 5, Data.F, 6, [0.0], -1, [0.0], -1, [0.0], -1)
	build_00d0!(Data, Libint.int_stack, vrr_stack+201, Libint.int_stack, vrr_stack+3, Libint.int_stack, vrr_stack+0, Data.F, 4, Data.F, 5, [0.0], -1)
	build_00f0!(Data, Libint.int_stack, vrr_stack+207, Libint.int_stack, vrr_stack+95, Libint.int_stack, vrr_stack+201, Libint.int_stack, vrr_stack+30, Libint.int_stack, vrr_stack+3, [0.0], -1)
	build_00g0!(Data, Libint.int_stack, vrr_stack+217, Libint.int_stack, vrr_stack+101, Libint.int_stack, vrr_stack+207, Libint.int_stack, vrr_stack+33, Libint.int_stack, vrr_stack+95, [0.0], -1)
	build_p0g0!(Data, Libint.int_stack, vrr_stack+232, Libint.int_stack, vrr_stack+171, Libint.int_stack, vrr_stack+217, [0.0], -1, [0.0], -1, Libint.int_stack, vrr_stack+101)
	build_p0g0!(Data, Libint.int_stack, vrr_stack+277, Libint.int_stack, vrr_stack+186, Libint.int_stack, vrr_stack+171, [0.0], -1, [0.0], -1, Libint.int_stack, vrr_stack+75)
	tmp = vrr_stack + 277
	target_ptr = Libint.vrr_classes[2,5]
	for i = 1:45
		Libint.int_stack[target_ptr+i] += Libint.int_stack[tmp+i]
	end
	build_d0d0!(Data, Libint.int_stack, vrr_stack+322, Libint.int_stack, vrr_stack+57, Libint.int_stack, vrr_stack+39, Libint.int_stack, vrr_stack+24, Libint.int_stack, vrr_stack+15, Libint.int_stack, vrr_stack+6)
	tmp = vrr_stack + 322
	target_ptr = Libint.vrr_classes[3,3]
	for i = 1:36
		Libint.int_stack[target_ptr+i] += Libint.int_stack[tmp+i]
	end
	build_d0f0!(Data, Libint.int_stack, vrr_stack+358, Libint.int_stack, vrr_stack+141, Libint.int_stack, vrr_stack+111, Libint.int_stack, vrr_stack+85, Libint.int_stack, vrr_stack+75, Libint.int_stack, vrr_stack+39)
	tmp = vrr_stack + 358
	target_ptr = Libint.vrr_classes[3,4]
	for i = 1:60
		Libint.int_stack[target_ptr+i] += Libint.int_stack[tmp+i]
	end
	build_d0g0!(Data, Libint.int_stack, vrr_stack+0, Libint.int_stack, vrr_stack+277, Libint.int_stack, vrr_stack+232, Libint.int_stack, vrr_stack+186, Libint.int_stack, vrr_stack+171, Libint.int_stack, vrr_stack+111)
	tmp = vrr_stack + 0
